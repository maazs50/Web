...
public class MediCenter extends HttpServlet{
    ...
    public void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            PreparedStatement pst = connection.prepareStatement("insert into medi_center(name,timezone,description)values(?,?,?)");//try2 is the name of the table
